...
module.exports = exports = function (options) {
  ...
  pipeline.addStep('Fixing background', function(next) {
    var title = global.opts.title,
      windowHeight = (global.opts.window && global.opts.window.size && global.opts.window.size.height) || (global.bkgsize && global.bkgsize[0]) || 640,
      windowWidth = (global.opts.window && global.opts.window.size && global.opts.window.size.width) || (global.bkgsize && global.bkgsize[1]) || 480,
    ...
    exec('chmod +x ' + __dirname + '/fixbkg.sh && ' + __dirname + '/fixbkg.sh "' + title + '" ' + windowWidth + ' ' + windowHeight + ' ' + iconSize + ' ' + backgroundName + ' ' + iconPositions[0].name + ' ' + iconPositions[0].x + ' ' + iconPositions[0].y + ' ' + iconPositions[1].name + ' ' + iconPositions[1].x + ' ' + iconPositions[1].y,
